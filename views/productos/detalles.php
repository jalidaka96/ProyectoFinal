...
<body class="detalleContainer" ng-app="miApp" ng-controller="detalleItemCtrl">
	...
	<div class="container ">
		...
		<div class="row detalleItem">
			...
			<!--<img class="col-10 offset-1 offset-md-0 col-md-5 imagenItem" src="<?php echo constant('URL'); ?><?php echo $row['imagen']; ?>">-->
			...
			<div class="masDetalles col-10 offset-1 col-md-6">
				<p  class="nombreItem"><span>Nombre: </span><?php echo $row['nombre']; ?></p>
				<p class="precioItem"><span>Precio: </span><?php echo $row['precio']; ?>€</p><hr>
				<span>Descripción:</span>
				<p class="descripcionItem"><?php echo $row['detalle']; ?></p><hr>


				<button class="btn btn-primary " ng-hide="botones">Comprar ya!</button>

				<button class="btn btn-primary" ng-hide="botones"><span class="d-none d-lg-block" >Añadir a cesta</span> <span class="glyphicon glyphicon-shopping-cart d-lg-none"></span></button>
				...
				<div class="form-group" ng-show="campoComentar">
					<form >
						<label for="comment">Comment:</label>
				 		<textarea class="form-control" rows="5" id="comment" ng-model="comentario"></textarea>
		...
		<div class="row">
			...
			<a ng-hide="abajo" id="buttonShowComments" class="col-12"  ng-click="verComentarios(<?php echo $row['id_producto']; ?>)">
			...
			<a ng-show="arriba" id="buttonShowComments" class="col-12"  ng-click="ocultarComentarios()">
				<?php echo $cantidad['COUNT(*)']; ?> comentarios:
				<span class="glyphicon glyphicon-chevron-up"></span>
			</a>

			<p ng-show="vacio">NO HAY COMENTARIOS!</p>
			<div ng-show="vistaComentarios" class="col-12">
